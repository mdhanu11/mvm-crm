...
function PayslipTab() {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: ({ getValue }: any) => (
                <>
                    <button onClick={() => {
                        setState({ ...state, paySlipViewModalOpen: true, paySlipMonth: getValue() })
                    }}>{getValue()}</button>
                </>
            ),
        },
    ...
    return (
        <div className="space-y-5">
            ...
            <PaySlipViewModal isOpen={state.paySlipViewModalOpen} handleClose={() => { setState({ ...state, paySlipViewModalOpen: false }) }} paySlipMonth={state.paySlipMonth} />
            ...
            <div className="bg-white rounded-md p-4">
                ...
                <div className="flex justify-between items-center mb-4 gap-5">
                    ...
                    <Button onClick={() => { setIsOpen(true) }} variant='black' className='shrink-0' iconStart={<FiUpload />}>
                        Upload Payslip
                    </Button>
